...
n=0
for f in ${CONFCASE}_y????_TRCmean.dat ; do
 n=$(( n + 1 ))
...
if [ $n == 1 ] ; then
 echo "% CFC monitoring file for " $CONFCASE >> trc_cfc.mtl
 ...
 echo "% B-C14 monitoring file for " $CONFCASE >> trc_c14.mtl
...
mv trc_cfc.mtl $MONITORDIR/${CONFCASE}_trc_cfc.mtl
mv trc_c14.mtl $MONITORDIR/${CONFCASE}_trc_c14.mtl
