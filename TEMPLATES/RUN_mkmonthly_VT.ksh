#!/bin/ksh
#-----------------------------------------------------------------------
# $Id: mkmonthly_VT.ksh 20 2015-05-22 09:44:31Z molines $  mkmonthly_VT.ksh : compute monthly VT files from monthly U V T 
#-----------------------------------------------------------------------
. ./config_moy.ksh
