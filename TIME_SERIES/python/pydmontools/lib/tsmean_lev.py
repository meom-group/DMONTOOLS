...
def plot(argdict=myargs,figure=None,color='r',tmean=None,smean=None,sshmean=None,levels=None,date=None,tmodel=None,smodel=None,tlev=None,slev=None,compare=False):
    ...
    if not(compare):
       ...
       plt.contourf(date, levels, npy.transpose(tmodel[:,:]-tlev[:]),contours_temper, extend='both')
       ...
       plt.contourf(date, levels, npy.transpose(smodel[:,:]-slev[:]),contours_salin, extend='both')
