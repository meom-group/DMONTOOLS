...
name         = strcat('green: ',run1,' black: ',run2) ;
figname      = strcat(run1,'_',run2) ;
style1   = 'g.-' ;
style2   = 'k.-' ;
...
sea_icenoaa = 0 ; %% timeseries extent and area co,pared with Noaa data
...
% determine the shortest time serie from TMEAN.mtl file
...
%datadir=strcat('/home/molines/web/DRAKKAR/',config,run,'/DATA/')
